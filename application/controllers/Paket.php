	...
	public function ajax_list()
	{
		...
		foreach ($list as $paket) {
			...
			$row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_paket('."'".$paket->id_paket."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
				  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_user('."'".$paket->id_paket."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a><br><br>			 
				  <a class="btn btn-sm btn-info" href="javascript:void(0)" title="Get QR" onclick="get_qr('."'".$paket->awb."'".')"><i class="glyphicon glyphicon-trash"></i> Get QR</a>';
